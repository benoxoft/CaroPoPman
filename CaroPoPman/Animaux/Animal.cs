...
namespace CaroPoPman.Animaux
{
	public class Animal
	{
		...
		public string Race { 
			get { return _table.Rows [0] ["Race"].ToString(); }
			set { _table.Rows [0] ["Race"] = value; }
		}

		public float PrixBainSeul { 
			get { return (float)_table.Rows [0] ["PrixBainSeul"]; }
			set { _table.Rows [0] ["PrixBainSeul"] = value; }
		}

		public float PrixToilettage { 
			get { return (float)_table.Rows [0] ["PrixToilettage"]; }
			set { _table.Rows [0] ["PrixToilettage"] = value; }
		}

		public string Notes { 
			get { return _table.Rows [0] ["Notes"].ToString(); }
			set { _table.Rows [0] ["Notes"] = value; }
		}
